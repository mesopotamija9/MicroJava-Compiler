...
public class DesignatorListCommaAndDesignator extends DesignatorL {

    private DesignatorL DesignatorL;
    private Designator Designator;

    public DesignatorListCommaAndDesignator (DesignatorL DesignatorL, Designator Designator) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorListCommaAndDesignator(\n");
