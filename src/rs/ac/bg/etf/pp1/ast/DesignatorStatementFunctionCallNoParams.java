...
public class DesignatorStatementFunctionCallNoParams extends DesignatorStatement {

    private FunctionCallName FunctionCallName;

    public DesignatorStatementFunctionCallNoParams (FunctionCallName FunctionCallName) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementFunctionCallNoParams(\n");
